...
ACCESSORIES_IMAGES = {
    ...
    'Joy-Con(右のみ)': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/accessories/joycon.png?raw=true',
    'Joy-Con(両方)': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/accessories/joycon.png?raw=true',
...
OTHER_CITY_CHUSHI = {
    ...
    '尾道市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/onomichicityballpbmaker.png?raw=true',
...
JAPAN_CHOICES = [
    ...
    app_commands.Choice(name='その他の都市（関東）', value='その他の都市（関東）'),
    app_commands.Choice(name='その他の都市（中部）', value='その他の都市（中部）'),
