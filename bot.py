...
SPECIAL_CITY = {
    ...
    '太田市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/otacityballpbmaker.png?raw=true',
    '小田原市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/odawaracityballpbmaker.png?raw=true',
    '富士市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/fujicityballpbmaker.png?raw=true',
    '春日部市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/kasukabecityballpbmaker.png?raw=true',
    '草加市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/kusakacityballpbmaker.png?raw=true',
    '春日井市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/kasugaicityballpbmaker.png?raw=true',
    '茅ヶ崎市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/chigasakicityballpbmaker.png?raw=true',
    '岸和田市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/kishiwadacityballpbmaker.png?raw=true',
    '平塚市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/hiratsukacityballpbmaker.png?raw=true',
    '上越市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/joetsucityballpbmaker.png?raw=true',
    '宝塚市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/takarazukacityballpbmaker.png?raw=true',
    '大和市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/yamatocityballpbmaker.png?raw=true',
    '熊谷市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/kumagawacityballpbmaker.png?raw=true',
    '所沢市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/tokorozawacityballpbmaker.png?raw=true',
    '宝塚市': 'https://github.com/RepublicofAuech/polandballmaker/blob/main/flags/takarazukacityballpbmaker.png?raw=true',
}
